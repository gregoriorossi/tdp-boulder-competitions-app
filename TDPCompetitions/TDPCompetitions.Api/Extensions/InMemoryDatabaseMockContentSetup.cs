    ...
    public static class InMemoryDatabaseMockContentSetup
    {
        public static void AddInMemoryDatabaseMockContent(this WebApplication app)
        {
            ...
            var reg1 = new Registration
            {
                ...
                Email = "gregorio.rossi89@gmail.com",
                PhoneNumber = "+39 345 1111111",
                LastWaiverDownload = new DateTime(2026, 5, 1, 9, 45, 0, DateTimeKind.Local),
                CompetitionId = competitionId,
            ...
            var reg2 = new Registration
            {
                ...
                PhoneNumber = "+39 345 1111231",
                LastWaiverDownload = new DateTime(2025, 12, 22, 9, 45, 0, DateTimeKind.Local),
                Competitor = adult2,
            ...
            var reg3 = new Registration
            {
                ...
                PhoneNumber = "+39 345 1111144",
                LastWaiverDownload = null,
                CompetitionId = competitionId,
